...
namespace Framework
{
    [CustomEditor(typeof(VRInputManager))]
    public class VRInputManagerEditor : Editor
    {
        ...
        public static void SeedInputs(VRInputManager manager)
        {
            ...
            // this part is done in the most stupid way possible but I couldn't figure another way of doing it
            #region populating input 
            var inputAxes = new List<InputAxis>();
            switch (manager.type)
            {
                case ControllerType.Normal:
            ...
            foreach (var t in inputAxes)
            {
                if (!ElementExists(t.name, inputManagerCurrentData))
                {
                    AddAxe(t, ref inputManagerCurrentData);
                }
            }
        ...
        private static void AddAxe(InputAxis axe, ref SerializedProperty currentList)
        {
        ...
        private static  bool ElementExists(string name, UnityEditor.SerializedProperty currentList)
        {
