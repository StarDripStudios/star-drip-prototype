...
namespace Framework
{
    [CustomPropertyDrawer(typeof(HandConstraints))]
    public class ConstraintEditor : PropertyDrawer
    {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            var fingerPosition = new Rect(position.x, position.y + EditorGUIUtility.singleLineHeight, position.width,
                height);
